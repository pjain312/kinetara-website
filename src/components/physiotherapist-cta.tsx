...
export function PhysiotherapistCTA({ doctorName }: { doctorName: string }) {
  ...
  return (
    <>
      <div className="flex flex-col sm:flex-row gap-4 justify-center">
        ...
        >
          Book with {doctorName.split(" ").slice(0, 2).join(" ")} <ArrowRightIcon className="ml-2 h-5 w-5" />
        </Button>
      ...
      <AppointmentForm
        ...
        title={`Book Your Session — ${doctorName}`}
