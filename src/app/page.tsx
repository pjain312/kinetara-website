...
export const metadata = {
  ...
  keywords: [
    ...
    "physiotherapy in CR Park",
    "physiotherapy near CR Park",
    "physiotherapy clinic in GK1",
    "physiotherapy near GK1",
    "physiotherapy in GK2",
    "physiotherapy near GK2",
    "physiotherapy clinic in Alaknanda",
    "physiotherapy in Alaknanda",
    "physiotherapy near Alaknanda",
    "physiotherapy clinic in Govindpuri",
    "physiotherapy in Govindpuri",
    "physiotherapy near Govindpuri",
